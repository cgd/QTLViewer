class p_text implements p_component {
  double w, x, y, dx;
  String data, label;
  PFont font = createFont("Arial", 16, true);
  boolean ready = true, focus = false, active = true;

  p_text(double ex, double why, double desiredX, double doubleu, String el) {
    label = el;
    x = ex;
    y = why;
    w = doubleu;
  ...
  p_text(double ex, double why, double doubleu, String el) {
    label = el;
    x = ex;
    y = why;
    w = doubleu;
